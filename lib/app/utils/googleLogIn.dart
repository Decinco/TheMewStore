...
class GoogleLoginUtils {
  static Future<void> nativeGoogleSignIn(SupabaseClient supabase) async {
    ...
    const webClientId =
        '100431781632-vprn2pm4qq5p3mtl1hoiddaevv5at006.apps.googleusercontent.com';
    const clientId =
        '100431781632-fbmaumu4eiv075lin6oqjkvih0hpjknb.apps.googleusercontent.com';

    final GoogleSignIn googleSignIn =
        GoogleSignIn(serverClientId: webClientId, clientId: clientId);
